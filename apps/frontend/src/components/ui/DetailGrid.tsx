 ...
 * payload. Used inside every entity detail drawer (Sensors, Networks,
 * Devices, Account) for visual consistency.
 */
export function DetailSection({ label, children }: DetailSectionProps): JSX.Element {
  return (
