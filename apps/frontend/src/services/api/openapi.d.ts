...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        FindingKind: "protocol_hierarchy" | "conversations" | "deauth_bursts" | "eapol_handshakes" | "beacons" | "probe_response_anomalies" | "filter_failed";
        /**
         * FindingSeverity
